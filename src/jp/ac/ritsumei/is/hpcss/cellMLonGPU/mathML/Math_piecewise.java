...
public class Math_piecewise extends MathOperator {
    ...
    public Math_piecewise() {
        super("", eMathOperator.MOP_PIECEWISE,
                MathMLDefinition.MATH_OPERATOR_MIN_FACTOR_PIECEWISE);
    }

    /*-----演算命令メソッド-----*/
    public double calculate() throws MathException {
        throw new MathException("Math_piecewise", "calculate",
                "can't calculate");
    }
    ...
    public String toLegalString() throws MathException {
        ...
        if (m_vecFactor.size() < MathMLDefinition.MATH_OPERATOR_MIN_FACTOR_PIECEWISE) {
            throw new MathException("Math_piecewise", "toLegalString",
                    "lack of operand");
        }
        ...
        for (MathFactor it1 : m_vecFactor) {
            ...
            if (it1.matches(eMathMLClassification.MML_OPERATOR)) {
                ...
                /* otherwise演算子 */
                else if (((MathOperator) it1)
                        .matches(eMathOperator.MOP_OTHERWISE)) {

                    /* 重複チェック */
                    if (pMathOtherWise != null) {
                        throw new MathException("Math_piecewise",
                                "toLegalString", "too many otherwise");
                    } else {
