...
public class MathMLDefinition {
    ...
    public enum eMathMLClassification {
        MML_OPERATOR, MML_OPERAND, MML_OPTIONAL,
    };

    // -------------------------------------オペレータ列挙
    public enum eMathOperator {
        MOP_APPLY(MATH_OPERATOR_STR_APPLY), MOP_DIVIDE(MATH_OPERATOR_STR_DIVIDE), MOP_EQ(
                MATH_OPERATOR_STR_EQ), MOP_NEQ(MATH_OPERATOR_STR_NEQ), MOP_MINUS(
                MATH_OPERATOR_STR_MINUS), MOP_PLUS(MATH_OPERATOR_STR_PLUS), MOP_TIMES(
                MATH_OPERATOR_STR_TIMES), MOP_REMAINDER(
                MATH_OPERATOR_STR_REMAINDER), MOP_EXP(MATH_OPERATOR_STR_EXP), MOP_LOG(
                MATH_OPERATOR_STR_LOG), MOP_POWER(MATH_OPERATOR_STR_POWER), MOP_SIN(
                MATH_OPERATOR_STR_SIN), MOP_COS(MATH_OPERATOR_STR_COS), MOP_TAN(
                MATH_OPERATOR_STR_TAN), MOP_DIFF(MATH_OPERATOR_STR_DIFF), MOP_BVAR(
                MATH_OPERATOR_STR_BVAR), MOP_LT(MATH_OPERATOR_STR_LT), MOP_LEQ(
                MATH_OPERATOR_STR_LEQ), MOP_GT(MATH_OPERATOR_STR_GT), MOP_GEQ(
                MATH_OPERATOR_STR_GEQ), MOP_AND(MATH_OPERATOR_STR_AND), MOP_OR(
                MATH_OPERATOR_STR_OR), MOP_INC(MATH_OPERATOR_STR_INC), MOP_DEC(
                MATH_OPERATOR_STR_DEC), MOP_ASSIGN(MATH_OPERATOR_STR_ASSIGN), MOP_FN(
                MATH_OPERATOR_STR_FN), MOP_LN(MATH_OPERATOR_STR_LN), MOP_ROOT(
                MATH_OPERATOR_STR_ROOT), MOP_FLOOR(MATH_OPERATOR_STR_FLOOR), MOP_CEIL(
                MATH_OPERATOR_STR_CEIL), MOP_PIECEWISE(
                MATH_OPERATOR_STR_PIECEWISE), MOP_PIECE(MATH_OPERATOR_STR_PIECE), MOP_OTHERWISE(
                MATH_OPERATOR_STR_OTHERWISE), ;
    ...
    public enum eMathOperand {
        MOPD_CI(MATH_OPERAND_STR_CI), MOPD_CN(MATH_OPERAND_STR_CN), ;
        private final String operatorStr;
    ...
    //
    // ========================================================
    public static eMathMLClassification specifyMathMLClassification(
            String strTag) throws MathException {
        /* 演算子と比較 */
