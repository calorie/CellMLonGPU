...
public class SyntaxDataType {
    ...
    public enum eDataType {
        DT_VOID("void"), DT_CHAR("char"), DT_UCHAR("unsigned char"), DT_SHORT(
                "short"), DT_USHORT("unsigned short"), DT_INT("int"), DT_UINT(
                "unsigned int"), DT_FLOAT("float"), DT_DOUBLE("double"), DT_DIM3(
                "dim3"), DT_MPISTA("MPI_Status"), DT_FILE("FILE"), DT_ENTRY(
                "ENTRY"), ;
    ...
    //
    // ===================================================
    public void addArrayElementFactor(long ulElementNum) throws MathException {
        /* 要素数をMath_cnに変換 */
        Math_cn pTmpConst = (Math_cn) MathFactory.createOperand(
                eMathOperand.MOPD_CN, String.valueOf(ulElementNum));
    ...
    //
    // ===================================================
    public String toStringSuffix() throws MathException {
        /* 結果文字列 */
