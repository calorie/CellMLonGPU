...
public class MathMLAnalyzer extends XMLAnalyzer {
    ...
    public void findTagStart(String strTag, XMLAttribute pXMLAttr)
        ...
        case MML_OPERATOR:
            ...
            /* 新しい計算式 */
            if (m_pCurMathExpression == null
                    || !m_pCurMathExpression.isConstructing()) {
                this.addNewExpression();
            }

            /* 演算子を追加 */
            m_pCurMathExpression
                    .addOperator(MathFactory.createOperator(MathMLDefinition
                            .getMathOperatorId(strTag)));
        ...
        case MML_OPERAND:
            ...
            try {
                /* typeを取得 */
                String strSepType = pXMLAttr
                        .getValue(MathMLDefinition.MATHML_ATTR_STR_TYPE);
    ...
    public void findTagEnd(String strTag) throws MathException, RelMLException,
        ...
        case MML_OPERATOR:
            ...
            /* オペレータの終端タグ */
            m_pCurMathExpression.breakOperator(MathFactory
                    .createOperator(MathMLDefinition.getMathOperatorId()));
    ...
    public void findText(String strText) throws MathException, CellMLException,
        ...
        // -----------------------------------変数の登録
        case MOPD_CI:
            m_pCurMathExpression.addVariable(MathFactory.createOperand(
                    eMathOperand.MOPD_CI, strText));
            break;
        ...
        case MOPD_CN:
            ...
            if (m_bUseSep) {
                ...
                /* sep第2定数 */
                    ...
                    /* sep定数の登録 */
                    m_pCurMathExpression.addOperand(MathFactory.createOperand(
                            eMathOperand.MOPD_CN, "(double)"
            ...
            /* 通常の定数の登録 */
                ...
                m_pCurMathExpression.addOperand(MathFactory.createOperand(
                        eMathOperand.MOPD_CN, "(double)" + strText));
            }
            break;
