...
int main ( int argc , char** argv ) {
	...
	if( ( node == 0 ) ){
		...
		all_xo = (double*)malloc (  ( sizeof( double ) *  ( 8 * __MASTER_DATA_NUM )  )  ) ; ;
		...
		for(t = 0.000000; ( t <= 400.000000 ) ;t =  ( t + d ) ){
			...
			for(__j = 0; ( __j < __MASTER_DATA_NUM ) ;__j++){
				...
				all_xo[ (  ( 0 * __DATA_NUM )  + __j ) ] = xo[ (  ( 0 * __MASTER_DATA_NUM )  + __j ) ];
				all_xo[ (  ( 1 * __DATA_NUM )  + __j ) ] = xo[ (  ( 1 * __MASTER_DATA_NUM )  + __j ) ];
				all_xo[ (  ( 2 * __DATA_NUM )  + __j ) ] = xo[ (  ( 2 * __MASTER_DATA_NUM )  + __j ) ];
				all_xo[ (  ( 3 * __DATA_NUM )  + __j ) ] = xo[ (  ( 3 * __MASTER_DATA_NUM )  + __j ) ];
				all_xo[ (  ( 4 * __DATA_NUM )  + __j ) ] = xo[ (  ( 4 * __MASTER_DATA_NUM )  + __j ) ];
				all_xo[ (  ( 5 * __DATA_NUM )  + __j ) ] = xo[ (  ( 5 * __MASTER_DATA_NUM )  + __j ) ];
				all_xo[ (  ( 6 * __DATA_NUM )  + __j ) ] = xo[ (  ( 6 * __MASTER_DATA_NUM )  + __j ) ];
				all_xo[ (  ( 7 * __DATA_NUM )  + __j ) ] = xo[ (  ( 7 * __MASTER_DATA_NUM )  + __j ) ];
		...
		xi = (double*)malloc (  ( sizeof( double ) *  ( 8 * __WORKER_DATA_NUM )  )  ) ; ;
		xo = (double*)malloc (  ( sizeof( double ) *  ( 8 * __WORKER_DATA_NUM )  )  ) ; ;
		x1 = (double*)malloc (  ( sizeof( double ) *  ( 8 * __WORKER_DATA_NUM )  )  ) ; ;
		x2 = (double*)malloc (  ( sizeof( double ) *  ( 8 * __WORKER_DATA_NUM )  )  ) ; ;
		x3 = (double*)malloc (  ( sizeof( double ) *  ( 8 * __WORKER_DATA_NUM )  )  ) ; ;
		x4 = (double*)malloc (  ( sizeof( double ) *  ( 8 * __WORKER_DATA_NUM )  )  ) ; ;
		x5 = (double*)malloc (  ( sizeof( double ) *  ( 8 * __WORKER_DATA_NUM )  )  ) ; ;
		y1 = (double*)malloc (  ( sizeof( double ) *  ( 31 * __WORKER_DATA_NUM )  )  ) ; ;
		y2 = (double*)malloc (  ( sizeof( double ) *  ( 31 * __WORKER_DATA_NUM )  )  ) ; ;
		y3 = (double*)malloc (  ( sizeof( double ) *  ( 31 * __WORKER_DATA_NUM )  )  ) ; ;
		y4 = (double*)malloc (  ( sizeof( double ) *  ( 31 * __WORKER_DATA_NUM )  )  ) ; ;
		k1 = (double*)malloc (  ( sizeof( double ) *  ( 8 * __WORKER_DATA_NUM )  )  ) ; ;
		k2 = (double*)malloc (  ( sizeof( double ) *  ( 8 * __WORKER_DATA_NUM )  )  ) ; ;
		k3 = (double*)malloc (  ( sizeof( double ) *  ( 8 * __WORKER_DATA_NUM )  )  ) ; ;
		k4 = (double*)malloc (  ( sizeof( double ) *  ( 8 * __WORKER_DATA_NUM )  )  ) ; ;
		z = (double*)malloc (  ( sizeof( double ) * 18 )  ) ; ;
		for(t = 0.000000; ( t <= 400.000000 ) ;t =  ( t + d ) ){
